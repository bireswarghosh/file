...
const initAutocomplete = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // console.log("hi, i am working 919");
    
    // Skip validation check to ensure the form submits
    ...
    try {
      ...
      const dataToSubmit = {
        ...formData,
        // Make sure doctor ID is properly included in the submission
        UCDoctor1Id: formData.doctorId // Add the doctor ID for the API
      };
                              ...
                              if (response.data && response.data.success && response.data.data.length > 0) {
                                ...
                                if (patients.length === 1) {
                                  ...
                                  setFormData(prev => ({
                                    ...
                                    Relation: patientData.Relation || prev.Relation,
        ...
        <PatientSearchModal
          ...
          onSelectPatient={(selectedPatient) => {
            setFormData(prev => ({
              ...
              Relation: selectedPatient.Relation || prev.Relation,
