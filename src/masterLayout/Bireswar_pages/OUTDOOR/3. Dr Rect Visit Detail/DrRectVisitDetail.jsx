...
const DrRectVisitDetail = () => {
  ...
  const handlePrintReport = async () => {
    ...
    if (viewOption !== 'UserWise' || doctorSelect !== 'allDoctors' || (reportType !== 'All' && reportType !== 'Only Doctor Ch.' && reportType !== 'Only Service Ch.' && reportType !== "Doctor's Ch. (Summary)")) {
      alert('Please select: View Options = UserWise, Doctor Selection = All Doctors, Report Type = All, Only Doctor Ch., Only Service Ch., or Doctor\'s Ch. (Summary)');
      return;
    }
